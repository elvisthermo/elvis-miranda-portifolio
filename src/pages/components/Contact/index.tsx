    ...
    <div className="wrapper">
            <div className="col-a">
              ...
              <div className="content">
                <ul>
                  <li>
                    <a
                      href="mailto: elvis.thermo@gmail.com"
                      title="Enviar e-mail"
                    >
                      <svg
                        width="24"
                      ...
                      elvis.thermo@gmail.com
                    </a>
                  </li>
                  <li>
                    <a href="tel:+5591982126057" title="Fazer ligação">
                      <Image
                        width="24"
                        height="24"
                ...
                <a
                  ...
                  href="https://api.whatsapp.com/send?phone=5591982126057&text=Oi,%20Elvis!%20Vim%20do%20teu%20portifólio,%20quero%20trabalhar%20contigo!"
                  target="_blank"
                  rel="noreferrer"
                >
                  <svg
            ...
            <div className="col-b">
              <Image
                width={400}
                height={400}
                src="/assets/images/Devices-pana.svg"
                alt="Ícone de celular."
                layout="fixed"
              />
            </div>
